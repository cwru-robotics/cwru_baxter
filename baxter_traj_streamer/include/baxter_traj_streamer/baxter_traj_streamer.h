...
public:
    ...
    void stuff_right_trajectory( std::vector<Eigen::VectorXd> qvecs, trajectory_msgs::JointTrajectory &new_trajectory);
    void stuff_left_trajectory(std::vector<Eigen::VectorXd> qvecs, trajectory_msgs::JointTrajectory &new_trajectory);
    void stuff_left_trajectory(std::vector<Vectorq7x1> qvecs, trajectory_msgs::JointTrajectory &new_trajectory);
    ...
    // Luc added code here for left arm control
    void pub_left_arm_trajectory(trajectory_msgs::JointTrajectory &new_trajectory);
    Vectorq7x1 get_qvec_left_arm();
    void pub_left_arm_trajectory_init();
 ...
 private:
    ...
    // Luc again here
    void map_left_arm_joint_indices(vector<string> joint_names);
